...
namespace BulkyWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        [BindProperty] // ShoppingCartVM property will automatically be populated
        ...
        [HttpPost]
        [ActionName("Summary")] // we have to be explicit because the names are different -> Summary and SummaryPOST
